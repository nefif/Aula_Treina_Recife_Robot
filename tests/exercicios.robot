*** Settings ***    
Documentation     Este arquivo tem como objetivo praticar o uso de variáveis, loops e condições no Robot Framework. 
...
Cenario: Somando dois numeros
    [Tags]                SOMAR
    ${RESULTADO}    Somar dois numeros "3" e "4" com sucesso
